...
function changeWeather(weather)
{
	...
	{
		case 'sun':
			console.log(sizes.card.height / 1.5);
			TweenMax.to(sun.node, 4, {x: sizes.card.width / 2, y: sizes.card.height / 1.5, ease: Power2.easeInOut});
			//TweenMax.to(sunburst.node, 4, {scale: 1, opacity: 0.8, y: (sizes.card.height/1.5) + (sizes.card.offset.top), ease: Power2.easeInOut});
			break;
		default:
